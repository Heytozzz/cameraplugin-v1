...
public class Utils {
	...
	private static void loadBlockColors() {
		...
		blocksMap.put(Material.COBBLESTONE_WALL, new Color(130,130,130));
		blocksMap.put(Material.FURNACE, new Color(130,130,130));
		blocksMap.put(Material.STONE, new Color(100,100,100));
		blocksMap.put(Material.STONE_SLAB, new Color(100,100,100));
		blocksMap.put(Material.STONE_STAIRS, new Color(100,100,100));
		...
		blocksMap.put(Material.SANDSTONE_STAIRS, new Color(213,207,162));
		blocksMap.put(Material.SANDSTONE_SLAB, new Color(213,207,162));
		blocksMap.put(Material.SANDSTONE_WALL, new Color(213,207,162));
		blocksMap.put(Material.RED_SAND, new Color(191,108,49));
		blocksMap.put(Material.RED_SANDSTONE, new Color(180,100,50));
		blocksMap.put(Material.RED_SANDSTONE_STAIRS, new Color(180,100,50));
		blocksMap.put(Material.RED_SANDSTONE_SLAB, new Color(180,100,50));
		blocksMap.put(Material.RED_SANDSTONE_WALL, new Color(180,100,50));
		...
		blocksMap.put(Material.ANDESITE_STAIRS, new Color(136,136,138));
		blocksMap.put(Material.ANDESITE_SLAB, new Color(136,136,138));
		blocksMap.put(Material.ANDESITE_WALL, new Color(136,136,138));
		blocksMap.put(Material.DIORITE, new Color(181,181,181));
		blocksMap.put(Material.DIORITE_STAIRS, new Color(181,181,181));
		blocksMap.put(Material.DIORITE_SLAB, new Color(181,181,181));
		blocksMap.put(Material.DIORITE_WALL, new Color(181,181,181));
		...
		blocksMap.put(Material.GRANITE_STAIRS, new Color(156,111,91));
		blocksMap.put(Material.GRANITE_SLAB, new Color(156,111,91));
		blocksMap.put(Material.GRANITE_WALL, new Color(156,111,91));
		...
		blocksMap.put(Material.SPRUCE_TRAPDOOR, new Color(100,78,47));
		blocksMap.put(Material.SPRUCE_SIGN, new Color(100,78,47));
		blocksMap.put(Material.SPRUCE_HANGING_SIGN, new Color(100,78,47));
		...
		blocksMap.put(Material.OAK_HANGING_SIGN, new Color(172,140,88));
		...
		blocksMap.put(Material.BIRCH_PRESSURE_PLATE, new Color(202,185,131));
		blocksMap.put(Material.BIRCH_DOOR, new Color(202,185,131));
		blocksMap.put(Material.BIRCH_TRAPDOOR, new Color(202,185,131));
		blocksMap.put(Material.BIRCH_SIGN, new Color(202,185,131));
		blocksMap.put(Material.BIRCH_HANGING_SIGN, new Color(202,185,131));
		...
		blocksMap.put(Material.JUNGLE_PRESSURE_PLATE, new Color(172,124,89));
		blocksMap.put(Material.JUNGLE_DOOR, new Color(172,124,89));
		blocksMap.put(Material.JUNGLE_TRAPDOOR, new Color(172,124,89));
		blocksMap.put(Material.JUNGLE_SIGN, new Color(172,124,89));
		blocksMap.put(Material.JUNGLE_HANGING_SIGN, new Color(172,124,89));
		...
		blocksMap.put(Material.ACACIA_TRAPDOOR, new Color(178,102,60));
		blocksMap.put(Material.ACACIA_SIGN, new Color(178,102,60));
		blocksMap.put(Material.ACACIA_HANGING_SIGN, new Color(178,102,60));
		...
		blocksMap.put(Material.DARK_OAK_PRESSURE_PLATE, new Color(62,41,18));
		blocksMap.put(Material.DARK_OAK_DOOR, new Color(62,41,18));
		blocksMap.put(Material.DARK_OAK_TRAPDOOR, new Color(62,41,18));
		blocksMap.put(Material.DARK_OAK_SIGN, new Color(62,41,18));
		blocksMap.put(Material.DARK_OAK_HANGING_SIGN, new Color(62,41,18));
		...
		blocksMap.put(Material.QUARTZ_STAIRS, new Color(235,229,222));
		blocksMap.put(Material.QUARTZ_SLAB, new Color(235,229,222));
		blocksMap.put(Material.SMOOTH_QUARTZ, new Color(235,229,222));
		blocksMap.put(Material.SMOOTH_QUARTZ_STAIRS, new Color(235,229,222));
		blocksMap.put(Material.SMOOTH_QUARTZ_SLAB, new Color(235,229,222));
		...
		blocksMap.put(Material.COBBLED_DEEPSLATE_STAIRS, new Color(70,70,72));
		blocksMap.put(Material.COBBLED_DEEPSLATE_SLAB, new Color(70,70,72));
		blocksMap.put(Material.COBBLED_DEEPSLATE_WALL, new Color(70,70,72));
		blocksMap.put(Material.POLISHED_DEEPSLATE, new Color(74,74,78));
		blocksMap.put(Material.POLISHED_DEEPSLATE_STAIRS, new Color(74,74,78));
		blocksMap.put(Material.POLISHED_DEEPSLATE_SLAB, new Color(74,74,78));
		blocksMap.put(Material.POLISHED_DEEPSLATE_WALL, new Color(74,74,78));
		blocksMap.put(Material.DEEPSLATE_BRICKS, new Color(70,70,74));
		blocksMap.put(Material.DEEPSLATE_BRICK_STAIRS, new Color(70,70,74));
		blocksMap.put(Material.DEEPSLATE_BRICK_SLAB, new Color(70,70,74));
		blocksMap.put(Material.DEEPSLATE_BRICK_WALL, new Color(70,70,74));
		blocksMap.put(Material.DEEPSLATE_TILES, new Color(60,60,64));
		blocksMap.put(Material.DEEPSLATE_TILE_STAIRS, new Color(60,60,64));
		blocksMap.put(Material.DEEPSLATE_TILE_SLAB, new Color(60,60,64));
		blocksMap.put(Material.DEEPSLATE_TILE_WALL, new Color(60,60,64));
		...
		blocksMap.put(Material.TUFF_STAIRS, new Color(108,108,101));
		blocksMap.put(Material.TUFF_SLAB, new Color(108,108,101));
		blocksMap.put(Material.TUFF_WALL, new Color(108,108,101));
		blocksMap.put(Material.TUFF_BRICKS, new Color(104,104,98));
		blocksMap.put(Material.TUFF_BRICK_STAIRS, new Color(104,104,98));
		...
		blocksMap.put(Material.MUD_BRICK_STAIRS, new Color(146,116,89));
		blocksMap.put(Material.MUD_BRICK_SLAB, new Color(146,116,89));
		blocksMap.put(Material.MUD_BRICK_WALL, new Color(146,116,89));
		...
		blocksMap.put(Material.CUT_COPPER_STAIRS, new Color(194,116,86));
		blocksMap.put(Material.CUT_COPPER_SLAB, new Color(194,116,86));
		blocksMap.put(Material.EXPOSED_CUT_COPPER, new Color(146,144,120));
		blocksMap.put(Material.EXPOSED_CUT_COPPER_STAIRS, new Color(146,144,120));
		blocksMap.put(Material.EXPOSED_CUT_COPPER_SLAB, new Color(146,144,120));
		blocksMap.put(Material.WEATHERED_CUT_COPPER, new Color(109,143,120));
		blocksMap.put(Material.WEATHERED_CUT_COPPER_STAIRS, new Color(109,143,120));
		blocksMap.put(Material.WEATHERED_CUT_COPPER_SLAB, new Color(109,143,120));
		blocksMap.put(Material.OXIDIZED_CUT_COPPER, new Color(82,162,132));
		blocksMap.put(Material.OXIDIZED_CUT_COPPER_STAIRS, new Color(82,162,132));
		blocksMap.put(Material.OXIDIZED_CUT_COPPER_SLAB, new Color(82,162,132));
		...
		blocksMap.put(Material.MANGROVE_STAIRS, new Color(117,53,39));
		blocksMap.put(Material.MANGROVE_SLAB, new Color(117,53,39));
		blocksMap.put(Material.MANGROVE_FENCE, new Color(117,53,39));
		blocksMap.put(Material.MANGROVE_FENCE_GATE, new Color(117,53,39));
		blocksMap.put(Material.MANGROVE_BUTTON, new Color(117,53,39));
		blocksMap.put(Material.MANGROVE_PRESSURE_PLATE, new Color(117,53,39));
		blocksMap.put(Material.MANGROVE_DOOR, new Color(117,53,39));
		blocksMap.put(Material.MANGROVE_TRAPDOOR, new Color(117,53,39));
		blocksMap.put(Material.MANGROVE_SIGN, new Color(117,53,39));
		blocksMap.put(Material.MANGROVE_HANGING_SIGN, new Color(117,53,39));
		...
		blocksMap.put(Material.CHERRY_STAIRS, new Color(234,193,189));
		blocksMap.put(Material.CHERRY_SLAB, new Color(234,193,189));
		blocksMap.put(Material.CHERRY_FENCE, new Color(234,193,189));
		blocksMap.put(Material.CHERRY_FENCE_GATE, new Color(234,193,189));
		blocksMap.put(Material.CHERRY_BUTTON, new Color(234,193,189));
		blocksMap.put(Material.CHERRY_PRESSURE_PLATE, new Color(234,193,189));
		blocksMap.put(Material.CHERRY_DOOR, new Color(234,193,189));
		blocksMap.put(Material.CHERRY_TRAPDOOR, new Color(234,193,189));
		blocksMap.put(Material.CHERRY_SIGN, new Color(234,193,189));
		blocksMap.put(Material.CHERRY_HANGING_SIGN, new Color(234,193,189));
		blocksMap.put(Material.BAMBOO_BLOCK, new Color(135,183,26));
		blocksMap.put(Material.BAMBOO_PLANKS, new Color(195,157,60));
		blocksMap.put(Material.BAMBOO_STAIRS, new Color(195,157,60));
		blocksMap.put(Material.BAMBOO_SLAB, new Color(195,157,60));
		blocksMap.put(Material.BAMBOO_FENCE, new Color(195,157,60));
		blocksMap.put(Material.BAMBOO_FENCE_GATE, new Color(195,157,60));
		blocksMap.put(Material.BAMBOO_BUTTON, new Color(195,157,60));
		blocksMap.put(Material.BAMBOO_PRESSURE_PLATE, new Color(195,157,60));
		blocksMap.put(Material.BAMBOO_DOOR, new Color(195,157,60));
		blocksMap.put(Material.BAMBOO_TRAPDOOR, new Color(195,157,60));
		blocksMap.put(Material.BAMBOO_SIGN, new Color(195,157,60));
		blocksMap.put(Material.BAMBOO_HANGING_SIGN, new Color(195,157,60));
		blocksMap.put(Material.BAMBOO_MOSAIC, new Color(195,157,60));
		blocksMap.put(Material.BAMBOO_MOSAIC_STAIRS, new Color(195,157,60));
		blocksMap.put(Material.BAMBOO_MOSAIC_SLAB, new Color(195,157,60));
		...
		blocksMap.put(Material.NETHER_BRICK_STAIRS, new Color(44,22,27));
		blocksMap.put(Material.NETHER_BRICK_SLAB, new Color(44,22,27));
		blocksMap.put(Material.NETHER_BRICK_WALL, new Color(44,22,27));
		blocksMap.put(Material.NETHER_BRICK_FENCE, new Color(44,22,27));
		blocksMap.put(Material.RED_NETHER_BRICKS, new Color(70,10,10));
		blocksMap.put(Material.RED_NETHER_BRICK_STAIRS, new Color(70,10,10));
		blocksMap.put(Material.RED_NETHER_BRICK_SLAB, new Color(70,10,10));
		blocksMap.put(Material.RED_NETHER_BRICK_WALL, new Color(70,10,10));
		...
		blocksMap.put(Material.BLACKSTONE_STAIRS, new Color(42,36,40));
		blocksMap.put(Material.BLACKSTONE_SLAB, new Color(42,36,40));
		blocksMap.put(Material.BLACKSTONE_WALL, new Color(42,36,40));
		blocksMap.put(Material.POLISHED_BLACKSTONE, new Color(52,46,50));
		blocksMap.put(Material.POLISHED_BLACKSTONE_STAIRS, new Color(52,46,50));
		blocksMap.put(Material.POLISHED_BLACKSTONE_SLAB, new Color(52,46,50));
		blocksMap.put(Material.POLISHED_BLACKSTONE_WALL, new Color(52,46,50));
		blocksMap.put(Material.POLISHED_BLACKSTONE_PRESSURE_PLATE, new Color(52,46,50));
		blocksMap.put(Material.POLISHED_BLACKSTONE_BUTTON, new Color(52,46,50));
		...
		blocksMap.put(Material.CRIMSON_STAIRS, new Color(130,45,58));
		blocksMap.put(Material.CRIMSON_SLAB, new Color(130,45,58));
		blocksMap.put(Material.CRIMSON_FENCE, new Color(130,45,58));
		blocksMap.put(Material.CRIMSON_FENCE_GATE, new Color(130,45,58));
		blocksMap.put(Material.CRIMSON_BUTTON, new Color(130,45,58));
		blocksMap.put(Material.CRIMSON_PRESSURE_PLATE, new Color(130,45,58));
		blocksMap.put(Material.CRIMSON_DOOR, new Color(130,45,58));
		blocksMap.put(Material.CRIMSON_TRAPDOOR, new Color(130,45,58));
		blocksMap.put(Material.CRIMSON_SIGN, new Color(130,45,58));
		blocksMap.put(Material.CRIMSON_HANGING_SIGN, new Color(130,45,58));
		...
		blocksMap.put(Material.WARPED_STAIRS, new Color(39,136,127));
		blocksMap.put(Material.WARPED_SLAB, new Color(39,136,127));
		blocksMap.put(Material.WARPED_FENCE, new Color(39,136,127));
		blocksMap.put(Material.WARPED_FENCE_GATE, new Color(39,136,127));
		blocksMap.put(Material.WARPED_BUTTON, new Color(39,136,127));
		blocksMap.put(Material.WARPED_PRESSURE_PLATE, new Color(39,136,127));
		blocksMap.put(Material.WARPED_DOOR, new Color(39,136,127));
		blocksMap.put(Material.WARPED_TRAPDOOR, new Color(39,136,127));
		blocksMap.put(Material.WARPED_SIGN, new Color(39,136,127));
		blocksMap.put(Material.WARPED_HANGING_SIGN, new Color(39,136,127));
		...
		blocksMap.put(Material.END_STONE_BRICK_STAIRS, new Color(219,208,159));
		blocksMap.put(Material.END_STONE_BRICK_SLAB, new Color(219,208,159));
		blocksMap.put(Material.END_STONE_BRICK_WALL, new Color(219,208,159));
		blocksMap.put(Material.PURPUR_BLOCK, new Color(169,125,169));
		blocksMap.put(Material.PURPUR_STAIRS, new Color(169,125,169));
		blocksMap.put(Material.PURPUR_SLAB, new Color(169,125,169));
		...
		blocksMap.put(Material.PRISMARINE_STAIRS, new Color(99,157,152));
		blocksMap.put(Material.PRISMARINE_SLAB, new Color(99,157,152));
		blocksMap.put(Material.PRISMARINE_WALL, new Color(99,157,152));
		blocksMap.put(Material.PRISMARINE_BRICKS, new Color(99,171,158));
		blocksMap.put(Material.PRISMARINE_BRICK_STAIRS, new Color(99,171,158));
		blocksMap.put(Material.PRISMARINE_BRICK_SLAB, new Color(99,171,158));
		blocksMap.put(Material.DARK_PRISMARINE, new Color(51,89,74));
		blocksMap.put(Material.DARK_PRISMARINE_STAIRS, new Color(51,89,74));
		blocksMap.put(Material.DARK_PRISMARINE_SLAB, new Color(51,89,74));
