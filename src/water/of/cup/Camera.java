...
//										Bukkit.getLogger().info("MapID debug: " + mapId + " x: " + x + " y: " + y + " skipsLeft: " + skipsLeft);
	...
	public void addCameraRecipe() {
		...
		// Modern, non-reflective way to set a custom skull texture (replaces the old
		// GameProfile/reflection hack, which breaks whenever CraftMetaSkull's private
		// field layout changes between versions).
